...
public class SewaMobilActivity extends AppCompatActivity {
    ...
    String list_mobil[] = {"Toyota Avansa","Daihatsu Xenia","Mitsubishi Pajero","Toyota Fortuner"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> ad_mbl = new ArrayAdapter<>(SewaMobilActivity.this, android.R.layout.simple_spinner_dropdown_item, list_mobil);
    ...
    public void tmbl_OK(View view){
        ...
        if(ad_listmobil.getSelectedItem().toString()=="Toyota Avansa"){
            ...
            ttl_hargasewa = jml_lmsw * harga_sewa_mobil;
            harga_mobil.setText(Integer.toString(ttl_hargasewa));
        } else if (ad_listmobil.getSelectedItem().toString()=="Mitsubishi Pajero") {
